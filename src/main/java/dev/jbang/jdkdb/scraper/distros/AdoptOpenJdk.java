...
public class AdoptOpenJdk extends AdoptiumMarketplaceScraper {
	private static final String DISTRO = "adoptopenjdk";
	...
	protected String getAssetsPathTemplate() {
		return "/assets/feature_releases/%d/ga?project=jdk&distro=adoptopenjdk";
	}
	...
	protected JdkMetadata processAsset(JsonNode binary, String version, String javaVersion) {
		...
		return createStandardMetadata(binary, version, javaVersion, additionalFeatures);
	}
